...
# 1️⃣ Lire le CSV 
data = pd.read_csv("pi_results_for_weak_scaling.csv")
...
plt.plot([1, max(data['nprocess'])], [1, 1],
         linestyle='--', color='red', label='Temps idéal (y=1)')
...
plt.title("Weak Scaling - Speedup vs Nombre de threads")
